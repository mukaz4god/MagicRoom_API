...
namespace MagicHouse.Services
{
    public class BaseService : IBaseService
    {
        ...
        public async Task<T> SendAsync<T>(APIRequest apiRequest)
        {
            try
            {
                var client = httpClient.CreateClient("Home API");
                ...
                try
                {
                    ...
                    if(apiResponse.StatusCode == System.Net.HttpStatusCode.BadRequest || apiResponse.StatusCode == System.Net.HttpStatusCode.NotExtended)
                    {
